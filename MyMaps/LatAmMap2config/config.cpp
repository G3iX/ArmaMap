class CfgPatches
{
    class LatAmMap2_cf
    {
        name = "LatAmMap2 - Map Config";
        author = "GTH";
        requiredVersion = 1.60; //1.60 - apex mod adding
        requiredAddons[] = {"LatAmMap2_main","A3_Structures_F"};
        units[]= {};
        weapons[] = {};
    };
};
...
class CfgWorlds
{
    ...
    class LatAmMap2: CAWorld
    {
        class Names{
            #include "LatAmMap2.hpp" // init >=5 loc in order to see em' on map
        };
        class DefaultClutter;
        class Clutter{
    ...
    //    #include
    //}
    dynLightBrightnessAmbient=0.5;
    dynLightBrightnessAbsolute=0.050000001;
    class Sea
		{
		...
		worldId=4837;
		cutscenes[]= {};
		description="LatAmMap2"; 
		icon=""; 
		worldName = "MyMaps\LatAmMap2\LatAmMap2.wrp"; 
		previewVideo=""; 
		pictureMap=""; 
		pictureShot="";
		plateFormat="DG#$-####";
		...
		{
			satellite="MyMaps\LatAmMap2\data\gdt_wild_grass_co.paa"; 
